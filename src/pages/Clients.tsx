...
import { ArrowLeft, User, Phone, Mail, Calendar, Plus, MapPin, Cake, Edit2, Trash2 } from 'lucide-react';
...
export default function Clients({ onBack }: ClientsProps) {
                      ...
                      <div className="space-y-2 ml-9">
                        ...
                        {client.total_entries > 0 && (
                          <div className="flex items-center gap-2 text-gray-600">
                            ...
                            <span>Última visita: {formatDate(client.last_entry_date)}</span>
                          </div>
                        )}
                      </div>
                    </div>
                    <div className="flex flex-col items-end gap-4">
                      <div className="text-right">
                        ...
                        <div className="text-sm text-gray-500">
                          {client.total_entries === 1 ? 'visita' : 'visitas'}
                        </div>
                      </div>
