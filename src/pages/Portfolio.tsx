                ...
                >
                    <div className="max-w-5xl mx-auto text-center">
                        ...
                        <p className="text-xl text-gray-700 leading-relaxed mb-4">
                            ...
                            cosmetologia, formada pela Unicesumar. Desde a
                            conclusão do seu curso, sua trajetória tem sido
                            marcada pela busca constante de conhecimento e
                            aperfeiçoamento nas diversas técnicas que envolvem o
                            cuidado com a pele e o bem-estar.
                        </p>
                        <p className="text-xl text-gray-700 leading-relaxed mb-4">
                            Além da formação acadêmica, ela investiu em uma
                            série de cursos avulsos, incluindo massagem
                            modeladora, drenagem linfática e microagulhamento.
                            No entanto, Cris se destaca pela sua abordagem
                            humanizada. Para ela, o atendimento vai muito além
                            de procedimentos estéticos, é uma experiência de
                            cuidado integral que considera as necessidades
                            emocionais e físicas de cada cliente.
                        </p>
                        <p className="text-xl text-gray-700 leading-relaxed">
                            Cada tratamento que realiza é pensado para ser uma
                            experiência única de autocuidado, onde não só a pele
                            é renovada, mas a sensação de leveza e bem-estar é
                            promovida. Com um coração cheio de empatia, Cris é
                            uma facilitadora de transformação pessoal e
                            autoestima.
                        </p>
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                            <div
                                ...
                                style={{
                                    backgroundColor:
                                        colors.cardColorPortfolio.bgClaro,
                                }}
                            >
                                <p
                            ...
                            <div
                                ...
                                style={{
                                    backgroundColor:
                                        colors.cardColorPortfolio.bgBege,
                                }}
                            >
                                <p
                                    className="text-xl font-semibold"
                        ...
                        <div
                            ...
                            style={{
                                backgroundColor:
                                    colors.cardColorPortfolio.banner,
                            }}
                        >
                            <p
                                className="text-xl font-semibold"
                ...
                >
                    <div className="max-w-5xl mx-auto text-center">
                        ...
                        <p className="text-lg text-gray-700 leading-relaxed mb-6">
                            Atendimentos em domicílio em Balneário Camboriú, SC
                            e região.
                        </p>
                        <div className="flex justify-center">
                            <div
                ...
                <section id="outros" className="py-20 px-6 bg-white">
                    <div className="max-w-5xl mx-auto text-center">
                        ...
                        <p className="text-lg text-gray-700">
                            Mais informações sobre serviços adicionais e
                            diferenciais.
                        </p>
                    </div>
                </section>
